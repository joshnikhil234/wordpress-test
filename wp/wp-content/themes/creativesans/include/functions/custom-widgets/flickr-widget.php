<?php
/**
 * Plugin Name: SAINTDO Flickr Widget
...
class flickr extends WP_Widget {
	...
	function flickr() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'flickr-widget', __('Flickr SAINTDO', 'flickr'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('Flickr Widget', 'Flickr Widget'), 'id' => __('0', 'Flickr Witdget'), 'show_num' => '6', 'how' => 'lastest');
		...
		<p>
			...
			<label><?php _e('Max is "10"', 'example'); ?></label>
		</p>
		
        <p>
			<label for="<?php echo $this->get_field_id( 'how' ); ?>"><?php _e('What pictures to display'); ?></label><br />
