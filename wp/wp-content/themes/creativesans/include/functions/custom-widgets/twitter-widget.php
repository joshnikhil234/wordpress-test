...
class Twitter extends WP_Widget {
	...
	function Twitter() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'twitter-widget', 'description' => __('A widget that show Twitter feeds.', 'twitter-widget') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'twitter-widget' );

		/* Create the widget. */
		$this->WP_Widget( 'twitter-widget', __('Twitter SAINTDO', 'twitter'), $widget_ops, $control_ops );
	}
...
<?php
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('Twitter Widget', 'Twitter Widget'), 'twitter_username' => __('', 'Twitter Witdget'), 'show_num' => '5');
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'twitter_username' ); ?>"><?php _e('Twitter username', 'example'); ?></label>
