<?php 
/**
 * Template Name: Portfolio - 3 columns ,no details
 */
get_header();?>
                    	...
                    	<?php while(have_posts()) : the_post();?>		
							<?php include('include/portfolio/portfolio-check-case.php');?>
								...
								?>
										...
										<div class="<?php foreach( $getcat as $category ) { echo str_replace (" ", "",$category->name). '-forfilter '; } ?>All port-3-wrapper mb30 portfolio-item">
														<div class="h145 frame relative">
														<div class="hover-port relative h155 <?php echo $zoom;?>">
															...
															<div>
																...
																<?php if($image_id  == null):?>
																	<img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo get_template_directory_uri(); ?>/img/default.jpg&amp;h=155&amp;w=278&amp;zc=1" alt="<?php the_title(); ?>"/>
																<?php else: ?>
																	<img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb.php?src=<?php echo $image_url[0];?>&amp;h=155&amp;w=278&amp;zc=1" alt="<?php the_title(); ?>"/>
																<?php endif ?>
															</div>
														</div>
													</div>	
