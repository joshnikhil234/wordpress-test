<?php 
/**
 * Template Name: Portfolio - 4 columns ,no details
 */
get_header();?>
						...
						<?php if(have_posts()) : ?>
							<?php while(have_posts()) : the_post();?>		
								<?php include('include/portfolio/portfolio-check-case.php');?>
									...
									<div class="<?php foreach( $getcat as $category ) { echo str_replace (" ", "",$category->name). '-forfilter '; } ?>All port-4-wrapper mb30 mt0 portfolio-item">
